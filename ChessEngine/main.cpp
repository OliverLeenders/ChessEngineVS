...
void perft(Board* b, int depth) {
	...
	int total = 0;
	std::sort(moves->begin(), moves->end(), [b](Move* m_1, Move* m_2) -> bool {return Evaluator::compare(b, m_1, m_2, nullptr, nullptr, false); });
	for (Move* const& move : *moves) {
		int score = Evaluator::score_move(b, move, nullptr, nullptr, false);
		b->make_move(move);
